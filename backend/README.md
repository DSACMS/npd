...
We use [ruff](https://docs.astral.sh/ruff) to lint and format all Python in this project.

You can install it with `pip install ruff`, `brew install ruff`, or `make install-tools` and run it natively or with the `make lint` command.
