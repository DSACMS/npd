...
class EndpointTmp(models.Model):
    ...
    identifier_value = models.BigIntegerField(blank=True, null=True)
    address = models.CharField(max_length=1000, blank=True, null=True)
    fhir_endpoint_address = models.CharField(max_length=1000, blank=True, null=True)
    fhir_version = models.CharField(max_length=100, blank=True, null=True)
    vendor_name = models.CharField(max_length=100, blank=True, null=True)
    organization_id = models.UUIDField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = "endpoint_tmp"
