...
class ClinicalOrganization(models.Model):
    ...
    endpoint_instance = models.ForeignKey('EndpointInstance', models.DO_NOTHING, blank=True, null=True)
...
class EndpointInstance(models.Model):
    ...
    address = models.CharField(max_length=200)
    endpoint_connection_type = models.ForeignKey(EndpointConnectionType, models.DO_NOTHING, blank=True, null=True)
    name = models.CharField(max_length=200, blank=True, null=True)
    description = models.CharField(max_length=1000, blank=True, null=True)
    environment_type = models.ForeignKey('EnvironmentType', models.DO_NOTHING, blank=True, null=True)
...
class IndividualToPhone(models.Model):
    pk = models.CompositePrimaryKey('individual_id', 'phone_number', 'phone_use_id')
    individual = models.ForeignKey(Individual, models.DO_NOTHING)
...
class NuccClassification(models.Model):
    nucc_code = models.ForeignKey(Nucc, models.DO_NOTHING, db_column='nucc_code', blank=True, null=True)
...
class OrganizationToPhone(models.Model):
    pk = models.CompositePrimaryKey('organization_id', 'phone_number', 'phone_use_id')
    organization = models.ForeignKey(Organization, models.DO_NOTHING)
    phone_number = models.CharField(max_length=20)
    extension = models.CharField(max_length=10, blank=True, null=True)
    phone_use = models.ForeignKey(FhirPhoneUse, models.DO_NOTHING)
...
class ProviderToOrganization(models.Model):
    ...
    endpoint = models.ForeignKey(Endpoint, models.DO_NOTHING, blank=True, null=True)
